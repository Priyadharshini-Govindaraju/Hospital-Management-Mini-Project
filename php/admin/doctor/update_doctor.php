<?php
 include_once('../../config.php');
    ...
    if (isset($_POST['update'])){
        ...
        $sql1= "UPDATE `employee` SET  `name`= '".$name."',`shift`= '".$shift."',`specialist`= '".$specialist."',`phone_number`= '".$phone_number."',`email_id`= '".$email."',`salary`= '".$salary."' where `id`= $id";
...
<div class="w3-container w3-teal">
  ...
  <div>  <a href="doctor.php" style = "text-decoration:none;color:black;font-size:20px;margin-top:20px; margin-left:10px;" class="w3-bar-item w3-button w3-green" id='back-btn'>Back</a></div>
